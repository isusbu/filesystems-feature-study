...
SUFFIX="ext4-sqlitebench"
OUTPUT="sqlitebench-ext4"

echo "============================================"
echo " sqlite-bench Tracing — EXT4"
echo " Mount  : $MOUNT"
echo " DB Dir : $DB_DIR"
echo "============================================"
...
# Coverage
COUNT_FILE="/mnt/gpfs/fs-study/ext4-session-${SUFFIX}/${OUTPUT}.out.count"
if [ -f "$COUNT_FILE" ]; then
    ...
    echo ""
    echo "============================================"
    echo " EXT4 Coverage: $HIT / $TOTAL ($PCT%)"
