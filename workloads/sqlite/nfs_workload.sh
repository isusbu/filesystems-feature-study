...
SUFFIX="nfs-sqlitebench"
OUTPUT="sqlitebench-nfs"

echo "============================================"
echo " sqlite-bench Tracing — NFS"
echo " Mount  : $MOUNT"
echo " DB Dir : $DB_DIR"
echo "============================================"
...
# Coverage
COUNT_FILE="/mnt/gpfs/fs-study/nfs-session-${SUFFIX}/${OUTPUT}.out.count"
if [ -f "$COUNT_FILE" ]; then
    ...
    echo ""
    echo "============================================"
    echo " NFS Coverage: $HIT / $TOTAL ($PCT%)"
